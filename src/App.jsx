...
const CFG=[
  ...
  {name:"Projets 2026",dsId:"346dfc12-15cc-8021-897a-fa6b2cf1ae37",dsUrl:"collection://346dfc12-15cc-8070-8f8e-000bba2683fe",viewUrl:"view://346dfc12-15cc-8097-b1b8-000c917088ea",titleProp:"Nom",schema:{"Nom":{type:"title"},"Objectif":{type:"text"},"Verrous":{type:"text"},"Pôle":{type:"select",options:[{name:"Nutrition"},{name:"Environnement"},{name:"Sanitaire"},{name:"Science&Technique"},{name:"Social"},{name:"Economie"},{name:"Data"},{name:"Axe 1 - Animal durable"},{name:"Axe 2 - Santé & bien-être animal"},{name:"Axe 3 - Efficience reproductive"},{name:"Axe 4 - Qualité des produits"},{name:"Axe T - Outils & méthodes transverses"}]},"Axe ANR":{type:"select",options:[{name:"A.01 Terre solide et enveloppes fluides"},{name:"A.02 Terre vivante"},{name:"A.03 Biologie animaux/plantes/micro-organismes"},{name:"A.04 Alimentation et systèmes alimentaires"},{name:"B.01 Physique matière condensée et diluée"},{name:"B.02 Polymères/composites/matière molle"},{name:"B.03 Matériaux métalliques et inorganiques"},{name:"B.04 Sciences ingénierie et procédés"},{name:"B.05 Chimie moléculaire"},{name:"B.06 Chimie analytique/théorique/modélisation"},{name:"B.07 Physique"},{name:"C.01 Biochimie et chimie pour le vivant"},{name:"C.02 Macromolécules biologiques"},{name:"C.03 Génétique/génomique/ARN"},{name:"C.04 Biologie cellulaire et développement"},{name:"C.05 Physiologie et physiopathologie"},{name:"C.06 Immunologie/infectiologie/inflammation"},{name:"C.07 Neurosciences moléculaires et cellulaires"},{name:"C.08 Neurosciences intégratives et cognitives"},{name:"C.09 Recherche translationnelle en santé"},{name:"C.10 Innovation biomédicale"},{name:"C.11 Biologie et médecine régénérative"},{name:"D.01 Individus/entreprises/marchés/finance"},{name:"D.02 Institutions/normes/gouvernance"},{name:"D.03 Sociétés contemporaines"},{name:"D.04 Cognition/comportements/langage"},{name:"D.05 Arts/langues/littératures/philosophies"},{name:"D.06 Études du passé/patrimoines/cultures"},{name:"D.07 Sociétés et territoires en transition"},{name:"E.01 Fondements du numérique"},{name:"E.02 IA et science des données"},{name:"E.03 Génie logiciel et infrastructures"},{name:"E.04 Interaction/robotique"},{name:"E.05 Calcul haute performance/simulation"},{name:"E.06 Technologies quantiques"},{name:"F.01 Mathématiques"},{name:"G.01 Planétologie/structure de la Terre"},{name:"G.02 Physique subatomique et astrophysique"},{name:"H.01 Science de la durabilité"},{name:"H.02 Contaminants/écosystèmes/santé"},{name:"H.03 Maladies infectieuses et environnement"},{name:"H.04 Santé publique/santé/sociétés"},{name:"H.05 Méthodologies pour la transition écologique"},{name:"H.06 Dynamique des socio-écosystèmes"},{name:"H.07 Bioéconomie"},{name:"H.08 Sciences de base pour énergie"},{name:"H.09 Énergie durable/propre/sûre"},{name:"H.10 Nano-objets et nanomatériaux"},{name:"H.11 Capteurs/imageurs/instrumentation"},{name:"H.12 Micro et nanotechnologies pour information"},{name:"H.13 Technologies pour la santé"},{name:"H.14 Interfaces math-numérique / biologie-santé"},{name:"H.15 Interfaces math-numérique / SHS"},{name:"H.16 Interfaces math-numérique / Terre-environnement"},{name:"H.17 Sécurité globale/résilience/cybersécurité"},{name:"H.18 Villes/bâtiments/transport/mobilité"},{name:"H.19 Systèmes productifs de biens et services"}]},"CIR principal":{type:"select",options:[{name:"A1 Mathématiques et leurs applications"},{name:"A2 Sciences physiques de l'ingénieur"},{name:"A3 Sciences de la matière"},{name:"A4 STIC"},{name:"A5 Mathématiques appliquées"},{name:"A6 Génie civil / BTP"},{name:"A7 Génie des procédés"},{name:"B1 Chimie organique"},{name:"B2 Chimie inorganique"},{name:"B3 Chimie analytique"},{name:"B4 Chimie théorique / modélisation moléculaire"},{name:"B5 Chimie des matériaux"},{name:"B6 Chimie verte / procédés"},{name:"C1 Biologie animale"},{name:"C2 Biologie végétale"},{name:"C3 Biologie cellulaire / moléculaire"},{name:"C4 Génomique / bio-informatique"},{name:"C5 Sciences agronomiques et alimentaires"},{name:"C6 Sciences de l'environnement"},{name:"C7 Sciences médicales"},{name:"D1 Sciences économiques"},{name:"D2 Sciences de gestion"},{name:"D3 Sociologie"},{name:"D4 Psychologie / sciences cognitives"},{name:"D5 Histoire"},{name:"D6 Géographie / aménagement"},{name:"D7 Sciences politiques"},{name:"D8 Linguistique"},{name:"E1 Géosciences"},{name:"E2 Climatologie / océanographie"},{name:"F1 Mathématiques pures"}]},"CIR secondaire":{type:"select",options:[{name:"A1a Mathématiques fondamentales"},{name:"A1b Mathématiques appliquées"},{name:"A4a Architecture matérielle / systèmes"},{name:"A4b Réseaux et télécommunications"},{name:"A4c Sécurité informatique / cryptographie"},{name:"A4d Systèmes embarqués / temps réel"},{name:"A4e Interaction homme-machine / ergonomie"},{name:"A4f Génie logiciel / modélisation"},{name:"A4g Bases de données / web sémantique"},{name:"A4h IA / apprentissage / NLP"},{name:"A4i Systèmes d'information / SGBD"},{name:"A5a Statistique / probabilités"},{name:"A5b Optimisation / recherche opérationnelle"},{name:"A5c Modélisation / simulation numérique"},{name:"C1a Physiologie animale"},{name:"C1b Reproduction animale"},{name:"C1c Microbiote / physiologie digestive"},{name:"C5a Agronomie générale"},{name:"C5b Sciences animales (zootechnie)"},{name:"C5c Sciences végétales"},{name:"C5d Sciences agronomiques alimentation animale"},{name:"C5e Sciences alimentaires / nutrition"},{name:"C3a Biologie cellulaire"},{name:"C3b Biologie moléculaire"},{name:"C4a Bio-informatique"},{name:"C4b Génomique animale"},{name:"C6a Écologie / biodiversité"},{name:"C6b Sciences environnementales appliquées"},{name:"C7a Médecine humaine"},{name:"C7b Pharmacologie"},{name:"C7c Médecine vétérinaire"}]},"Démarrage":{type:"select",options:[{name:"2018"},{name:"2019"},{name:"2020"},{name:"2021"},{name:"2022"},{name:"2023"},{name:"2024"},{name:"2025"},{name:"2026"}]},"Cloture":{type:"select",options:[{name:"2019"},{name:"2020"},{name:"2021"},{name:"2022"},{name:"2023"},{name:"2024"},{name:"2025"},{name:"2026"},{name:"2027"},{name:"2028"}]},"TRL":{type:"select",options:[{name:"1"},{name:"2"},{name:"3"},{name:"4"},{name:"5"},{name:"6"},{name:"7"},{name:"8"},{name:"9"}]},"TRL Cible":{type:"select",options:[{name:"5"},{name:"6"},{name:"7"},{name:"8"},{name:"9"}]},"Gouvernance":{type:"select",options:[{name:"Interne"},{name:"Codev"},{name:"Presta"}]},"S. PI":{type:"select",options:[{name:"N.A"},{name:"Secret de affaires"},{name:"Brevet"},{name:"Demande de brevet"},{name:"Déclaration d'invention"},{name:"Publication scientifique"},{name:"Logiciel / Droit d'auteur"},{name:"Marque"},{name:"Co-propriété"},{name:"Licence"}]},"Programmes soutenus":{type:"text"},"Parties prenantes":{type:"text"},"Cadres stratégiques":{type:"text"},"Opportunités de financement":{type:"text"},"Lien Drive":{type:"url"},"Axe R&D&I":{type:"formula"},"Cohérence CIR":{type:"formula"},"Score D":{type:"formula"},"Score I":{type:"formula"},"Score R":{type:"formula"},"Axe stratégique":{type:"formula"},"type CI":{type:"rollup"},"Tot CICO obtenu":{type:"rollup"},"Tot CIR/CII obtenu":{type:"rollup"},"Tot Dépenses Engagées":{type:"rollup"},"Tot Sub obtenu":{type:"rollup"},"Tot dépenses valorisées":{type:"rollup"},"Société 2026":{type:"relation",dataSourceUrl:"collection://343dfc12-15cc-806c-aec4-000b4089c60b"},"Jalons annuels Projets 2026":{type:"relation",dataSourceUrl:"collection://346dfc12-15cc-80e3-8d11-000bcd38b4f9"},"Documents 2026":{type:"relation",dataSourceUrl:"collection://343dfc12-15cc-80e7-a558-000b92a6fff3"},"Risques & Alertes 2026":{type:"relation",dataSourceUrl:"collection://c49aaa84-043e-4e84-9a46-1a3cef2ba656"}}},
...
async function createPage(dbId,props,schema){
  ...
  if(!r.ok){const e=await r.json();throw new Error(JSON.stringify(e))}return(await r.json()).page;
}
  ...
  const renderCard=(row)=>{
    ...
    if(dn.includes("Projet")&&!dn.includes("Jalon")){
      ...
      return crd(<div style={{display:"flex",alignItems:"center",gap:12}}>
        ...
        <div style={{flex:1}}>
          <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:2,flexWrap:"wrap"}}><span style={{fontSize:14,fontWeight:700}}>{title}</span>{row.Gouvernance&&<Badge color="#0EA5E9">{row.Gouvernance}</Badge>}{row["S. PI"]&&row["S. PI"]!=="N.A"&&<Badge color="#7C3AED">{row["S. PI"]}</Badge>}{row["Pôle"]&&<Tag color="#D97706">{row["Pôle"].length>30?row["Pôle"].slice(0,30)+"…":row["Pôle"]}</Tag>}</div>
...
function DynForm({db,allDbs,modal,onClose,busy,onSave}){
  ...
  const NAME_EXCLUDE=new Set(["Statut","Etat","État","Priorité","Fonction","Assigned To","Exercice","Participants","TRL","TRL Cible","Gouvernance","S. PI","Démarrage","Cloture","Avancement","Sévérité","Actions à mener","Pôle"]);
  ...
  const renderField=([name,def])=>{
    ...
    if(def.type==="multi_select")return <div key={name} style={{display:"flex",flexDirection:"column",gap:4}}>
      <label style={{fontSize:11,fontWeight:600,color:"#999"}}>{name}</label>
      <div style={{display:"flex",gap:4,flexWrap:"wrap"}}>
        {(def.options||[]).map(o=>{const vals=(form[name]||"").split(", ").filter(Boolean);const on=vals.includes(o.name);return <button key={o.name} type="button" onClick={()=>{const cur=(form[name]||"").split(", ").filter(Boolean);const next=on?cur.filter(v=>v!==o.name):[...cur,o.name];set(name,next.join(", "))}} style={{padding:"4px 10px",borderRadius:8,border:"1.5px solid "+(on?"#2563EB":"#E2E8F0"),background:on?"#EFF6FF":"#fff",color:on?"#2563EB":"#888",fontSize:12,fontWeight:on?600:400,cursor:"pointer",fontFamily:font}}>{o.name}{on?" ✓":""}</button>})}
      </div>
    </div>;
